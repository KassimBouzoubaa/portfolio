...
export const data=[
    ...
    },
    {
        ...
        description:"Crypto Tutor est un blog éducatif sur la blockchain développé avec Next.js, React, Tailwind CSS, GraphQL et GraphCMS. Le blog offre un contenu informatif sur la blockchain, avec des sujets tels que les concepts fondamentaux, les tendances du marché, et les cas d'utilisation. Le site web est rapide, interactif et offre une expérience utilisateur fluide grâce à Next.js et React. Le design moderne et réactif est réalisé avec Tailwind CSS. GraphQL est utilisé pour gérer efficacement les données du blog, tandis que GraphCMS est utilisé comme système de gestion de contenu convivial pour la création et la publication de contenu. Crypto Tutor est un projet innovant visant à informer et éduquer les lecteurs sur la blockchain en utilisant les dernières technologies web pour offrir une expérience utilisateur optimale."
    },
    {
        id:2,
        name:"Metaverse",
